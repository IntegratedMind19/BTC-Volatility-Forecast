...
def market_context_builder():
  ...
  market_context_dict["market_data"] = dict() # retrieve_bitcoin_market_data()
  market_context_dict["macro_data"] = dict() # retrieve_macro_data()
  
  articles = dict() # retrieve_bitcoin_news(20)
